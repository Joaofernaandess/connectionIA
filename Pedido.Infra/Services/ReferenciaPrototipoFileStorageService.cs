...
public class ReferenciaPrototipoFileStorageService : IReferenciaPrototipoFileStorageService
{
    ...
    private static string MontarArquivoKey(string linkId)
    {
        ...
        return arquivo.StartsWith("prototipos/", StringComparison.OrdinalIgnoreCase)
            ? arquivo
            : $"prototipos/{arquivo}";
    }
