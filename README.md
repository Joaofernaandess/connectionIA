...
**CSS**
    ...
    <link href="https://cdn.jsdelivr.net/npm/zenite-ui@1.5.7/css/zenite.min.css" rel="stylesheet">

**JavaScript**

    <script src="https://cdn.jsdelivr.net/npm/zenite-ui@1.5.7/js/zenite.min.js"></script>
