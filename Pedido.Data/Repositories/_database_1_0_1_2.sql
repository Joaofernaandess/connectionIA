...
CREATE TABLE IF NOT EXISTS pedido_certo_ai.referencia_produto (
    ...
    cor_id UUID NULL REFERENCES pedido_certo_ai.cor(cor_id) ON DELETE SET NULL,
...
ALTER TABLE pedido_certo_ai.referencia_produto
ADD COLUMN IF NOT EXISTS cor_id UUID NULL REFERENCES pedido_certo_ai.cor(cor_id) ON DELETE SET NULL;
